...
class HelpersTest extends TestCase
{
    ...
    public function test_esnifar_y_guardar_nuevos_resultados()
    {

    }

    public function test_esnifar_y_guardar_resultados_disponibles()
    {

    }

    public function test_convertir_nombre_premio_a_nombre_de_sistema()
    {
