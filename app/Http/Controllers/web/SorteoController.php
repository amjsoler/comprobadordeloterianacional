...
class SorteoController extends Controller
{
    ...
    public function esnifarSorteos()
    {
        ...
        $sorteosDefinitivos = $sorteosObtenidos[0];

        //Leo de la bd los sorteos que hayan con las fechas de arriba
        $sorteosExistentes = Sorteo::whereIn("fecha", array_column($sorteosDefinitivos, "fecha"))->get();
//TODO:://Ahora quito del array a insertar, los elementos que ya estén en base de datos
        dd($sorteosExistentes);
    }
}
